        ...
        <div className="container">
          <div className="grid gap-10 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              <div
                className="overflow-hidden rounded-[4px] border border-[#d5d7db] bg-[#eef0f2] p-[5px] shadow-[0_4px_8px_rgba(0,0,0,0.10),0_1px_3px_rgba(0,0,0,0.06)]"
              >
                <div
                  className="rounded-[3px] border border-[#e2e4e8] bg-[#fafafa] shadow-[inset_0_1px_3px_rgba(0,0,0,0.04),inset_0_0_0_0.5px_rgba(255,255,255,0.7)] dark:border-slate-600 dark:bg-slate-800/80"
                >
                  {/* Map */}
                  <a
