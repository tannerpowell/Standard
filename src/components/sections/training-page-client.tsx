  ...
  return (
    <div
      ...
      style={{
        ...
        transform: reduceMotion ? "none" : `perspective(600px) rotateX(${tilt.rotateX}deg) rotateY(${tilt.rotateY}deg)`,
    ...
    >
      ...
      <div
        className={twMerge(
          clsx(
            "relative flex h-full flex-col items-center justify-center overflow-hidden rounded-[3px] border border-[#e2e4e8] px-4 py-5 text-center dark:border-slate-600 dark:bg-slate-800/80",
